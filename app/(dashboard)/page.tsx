          ...
          <div className="lg:grid lg:grid-cols-3 lg:gap-8">
            <div>
              ...
              <div className="mt-5">
                ...
                <p className="mt-2 text-base text-gray-500">
                  All your functions in one codebase. Our framework manages objects and state, seamlessly mapping on-chain and off-chain responsibilities.
                </p>
              </div>
            </div>
            ...
            <div className="mt-10 lg:mt-0">
              ...
              <div className="mt-5">
                ...
                <p className="mt-2 text-base text-gray-500">
                  No rigid APIs, no managed services, no server relays. You build business logic, we handle the rest.
                </p>
              </div>
            </div>
            ...
            <div className="mt-10 lg:mt-0">
              ...
              <div className="mt-5">
                ...
                <p className="mt-2 text-base text-gray-500">
                  Only pay for the compute you use.  Streamline your operations by cutting out unnecessary costs and intermediaries.
                </p>
              </div>
            </div>
          </div>
